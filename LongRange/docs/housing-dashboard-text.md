...
1. Open the dashboard side by side with this file.
2. Walk down the list. Under any line you want changed, type your new wording after **New:**.
3. Leave **New:** blank for anything you are happy with. You do not need to fill in every line.
...
# 1. Browser tab and header

**T01 — Browser tab title**
Now: Housing Progress Since 2012 — Tahoe Living
New:

**T02 — Small label above the page title**
Now: Housing dashboard
New:

**T03 — Page title (top of every screen, keep it short)**
Now: Housing Progress Since 2012
New:

Navigation links across the top right:
...
**T06** Now: Featured projects
New:

**T07** Now: Data
New:

**T08** Now: All planning tools
New:
...
### Card 4 — Placer commercial conversion
...
*Want a different project featured, or a fifth card? Say so under Other feedback. One
option already checked: Lake Tahoe Community College, 41 deed-restricted affordable
dormitory units built in 2025 by converting tourist accommodation units.*
...
Anything else: a section that should move, a chart that does not land, a project worth
featuring, a number that looks wrong, or wording you would rather discuss than rewrite.
